...
export class Hud {
    ...
    private _clockTime: TextBlock; // GAME TIME
    ...
    constructor (scene: Scene) {
        ...
        const sparklerLife = new Image("sparkLife", "https://raw.githubusercontent.com/BabylonJS/SummerFestival/master/public/sprites/sparkLife.png");
        ...
        const spark = new Image("spark", "https://raw.githubusercontent.com/BabylonJS/SummerFestival/master/public/sprites/spark.png");
        spark.width = "40px";
        spark.height = "40px";
        spark.cellId = 0;
        spark.cellHeight = 20;
        ...
        const pauseBtn = Button.CreateImageOnlyButton("pauseBtn", "https://raw.githubusercontent.com/BabylonJS/SummerFestival/master/public/sprites/pauseBtn.png");
        pauseBtn.width = "48px";
    ...
    private _formatTime(time: number): string {
        ...
        // game clock works like: 4mins = 1hr
        if (secPassed % 4 == 0) {
    ...
    private _createPauseMenu(): void {
        ...
        // background image
        const image = new Image("pause", "https://raw.githubusercontent.com/BabylonJS/SummerFestival/master/public/sprites/pause.jpeg");
        ...
        // when the button is down, make menu inviable and remove control of the menu
        resumeBtn.onPointerDownObservable.add(() => {
            this._pauseMenu.isVisble = false;
        ...
        Effect.RegisterShader("fade",
            ...
            "varying vec2 vUV;" +
            "unifrom sampler2D textureSampler; " +
    ...
    // Controls Menu Popup
    private _createControlMenu(): void {
        ...
        // background image
        const image = new Image("controls", "https://raw.githubusercontent.com/BabylonJS/SummerFestival/master/public/sprites/controls.jpeg");
        ...
        const backBtn = Button.CreateImageOnlyButton("back", "https://raw.githubusercontent.com/BabylonJS/SummerFestival/master/public/sprites/lanternbutton.jpeg");
        backBtn.width = "40px";
        backBtn.height = "40px";
        backBtn.top = "14px";
        backBtn.thickness = 0;
