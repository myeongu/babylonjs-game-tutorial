import { ParticleSystem, Color4, VertexBuffer, Mesh, Scene, MeshBuilder, SceneLoader, ActionManager, PBRMetallicRoughnessMaterial, Texture, Color3, TransformNode, ExecuteCodeAction, AnimationGroup, Sound, Vector3 } from "@babylonjs/core";
...
export class Environment {
    ...
    constructor(scene: Scene) {
        ...
        lightmtl.emissiveTexture = new Texture("https://raw.githubusercontent.com/BabylonJS/SummerFestival/master/public/textures/litLantern.png", this._scene, true, false);
    ...
    public async load() {
        ...
        for (let i=0; i < 22; i++) {
            ...
            let newLantern = new Lantern(this._lightmtl, lanternInstance, this._scene, assets.env.getChildTransformNodes(false).find(m => m.name === "lantern" + i + "lights")!.getAbsolutePosition(), animGroupClone);
...
class Firework {
    ...
    constructor(scene: Scene, i: number) {
        ...
        rocket.particleTexture = new Texture("https://raw.githubusercontent.com/BabylonJS/SummerFestival/master/public/textures/flare.png", scene);
    ...
    private _explosions(position: Vector3): void {
        ...
        for (let i = 0; i < vertPos!.length; i += 3) {
            ...
            particleSys.particleTexture = new Texture("https://raw.githubusercontent.com/BabylonJS/SummerFestival/master/public/textures/flare.png", this._scene);
    ...
    private _loadSounds(): void {
        this._rocketSfx = new Sound("selection", "https://raw.githubusercontent.com/BabylonJS/SummerFestival/master/public/sounds/fw_05.wav", this._scene, function () {
        }, {
            volume: 0.5,
        });

        this._explosionSfx = new Sound("selection", "https://raw.githubusercontent.com/BabylonJS/SummerFestival/master/public/sounds/fw_03.wav", this._scene, function () {
        }, {
            volume: 0.5,
        });
    }
